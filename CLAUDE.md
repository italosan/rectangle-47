...
Landing del workshop "Rectangle 47, seconda parte" (PUG Bari, 20 settembre 2026). Sito statico, un solo file, nessun build, deploy su Cloudflare Pages a ogni push.
...
- Niente framework, niente build, niente dipendenze. HTML e CSS nello stesso file.
